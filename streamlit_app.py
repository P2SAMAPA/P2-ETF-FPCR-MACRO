...
st.set_page_config(page_title="Functional Principal Component Regression (FPCR) with Macro", layout="wide")
...
def find_latest_json(files):
    json_files = [f for f in files if f.endswith('.json') and 'fpcr_macro_' in f]
    if not json_files:
        return None
